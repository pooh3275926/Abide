...
const CardDisplay: React.FC<{ card: JesusSaidCard }> = ({ card }) => (
  <div className="bg-beige-50 dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-md mx-auto">
    <div className="border-b-2 border-gold-light pb-3 mb-3">
      <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400">今日經文</h3>
      <p className="text-lg italic text-gold-dark dark:text-gold-light">"{card.verse}"</p>
    </div>
    <div className="border-b-2 border-gold-light pb-3 mb-3">
      <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400">耶穌對你說</h3>
      <p className="text-md whitespace-pre-wrap leading-relaxed">{card.message}</p>
    </div>
    <div>
      <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400">回應禱告</h3>
    ...
    <div className="container mx-auto max-w-2xl text-center p-4">
      ...
      <div className="mb-8 p-4 bg-beige-50 dark:bg-gray-800/50 rounded-lg">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300">
          每張卡片皆來自聖經經文與 AI 靈修生成，非占卜、非籤詩，而是「神今日的提醒與安慰」。
        </p>
      </div>
      ...
      <div className="mb-12">
        {currentCard ? (
          <div className="relative">
            ...
            <div className="text-center mt-4">
              <button
                ...
                className="px-6 py-2 bg-gold-DEFAULT text-black dark:text-white rounded-lg shadow-md hover:bg-gold-dark transition-colors"
              >
                ✨ 收藏卡片
              </button>
            </div>
          ...
          <>
            {gracePoints < 3 ? (
              <div className="p-6 bg-gold-light/50 dark:bg-gold-dark/30 rounded-lg text-center">
              ...
              <button
                ...
                disabled={isLoading}
                className="px-8 py-4 bg-gold-DEFAULT text-black dark:text-white rounded-lg shadow-xl hover:bg-gold-dark transition-colors transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mx-auto"
              >
                {isLoading ? (
                  <>
