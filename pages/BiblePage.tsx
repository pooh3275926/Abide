...
export default function BiblePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 sm:p-6 font-sans">
      ...
      <div className="bg-beige-50 dark:bg-gray-900 p-6 rounded-2xl shadow-lg overflow-x-auto">
        {verses.length > 0 ? (
          <>
          ...
          !loading && !error && <p className="text-center text-gray-500">請選擇書卷與章節後點擊查詢</p>
        )}
      </div>
    </div>
  );
