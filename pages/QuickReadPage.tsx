...
const QuickReadPage: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // 確保 JSON 結構完整
      const safeResult = {
        analysis: result.analysis || 'AI 暫無回應',
        application: result.application || 'AI 暫無回應',
        prayer: result.prayer || 'AI 暫無回應'
      };
      setCurrentResult(safeResult);
